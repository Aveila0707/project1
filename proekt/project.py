...
class EmployeeManagementApp:
    def __init__(self, master):
        self.master = master
        self.master.title("Employee Managenent App")
    ...
    def create_widgets(self):
        ...
        self.delete_button.pack(pady=10)
        self.search_button = tk.Button(self.master, text="Search Employer", command=self.search_employee)
    ...
    def update_employee(self):
        ...
        if employee:
            ...
            salary = simpledialog.askstring("Input", "Enter updated employee salary:", initialvalue=employee[4])
